...
// Wrap the expression with a dummy environment to make it syntactically a complete script
...
const test = ${replacementCode};
console.log("Expression compiled successfully!");
`;

try {
  new vm.Script(fullExpression);
  console.log("REPLACEMENT CODE IS STANDALONE VALID!");
} catch (e) {
  console.error("REPLACEMENT CODE STANDALONE FAILS WITH:");
